package saiMVCDeveloped.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "saiMVCDeveloped";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/Practice_MVcSai-model"),
        mapper("/Practice_MVcSai-dao"),
        mapperxml("/Practice_MVcSai-web"),
        service("/Practice_MVcSai-service"),
        web("/Practice_MVcSai-web"),
        ;
