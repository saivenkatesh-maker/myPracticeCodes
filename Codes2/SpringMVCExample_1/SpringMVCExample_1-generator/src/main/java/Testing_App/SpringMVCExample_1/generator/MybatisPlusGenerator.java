...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "Testing_App";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/SpringMVCExample_1-model"),
        mapper("/SpringMVCExample_1-dao"),
        mapperxml("/SpringMVCExample_1-web"),
        service("/SpringMVCExample_1-service"),
        web("/SpringMVCExample_1-web"),
        ;
