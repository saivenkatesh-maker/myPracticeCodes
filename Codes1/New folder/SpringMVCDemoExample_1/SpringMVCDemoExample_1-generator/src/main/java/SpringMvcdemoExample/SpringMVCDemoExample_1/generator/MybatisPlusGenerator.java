package SpringMvcdemoExample.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "SpringMvcdemoExample";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/SpringMVCDemoExample_1-model"),
        mapper("/SpringMVCDemoExample_1-dao"),
        mapperxml("/SpringMVCDemoExample_1-web"),
        service("/SpringMVCDemoExample_1-service"),
        web("/SpringMVCDemoExample_1-web"),
        ;
