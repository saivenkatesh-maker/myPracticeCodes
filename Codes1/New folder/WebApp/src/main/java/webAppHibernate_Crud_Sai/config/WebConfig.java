package webAppHibernate_Crud_Sai.config;
...
@Configuration
@ComponentScan(basePackages="webAppHibernate_Crud_Sai")
@EnableWebMvc
...
public class WebConfig{
	...
	public DataSource getDataSource() {
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/MediumDb");
	...
	public LocalSessionFactoryBean getSessionFactory(DataSource datSource) {
		...
		sessionfactory.setPackagesToScan("webAppHibernate_Crud_Sai.model");
